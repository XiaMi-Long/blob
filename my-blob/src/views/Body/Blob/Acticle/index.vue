 ...
 * @version: 
 * @Author: wwy
 * @Date: 2022-07-12 10:02:51
 * @LastEditors: wwy
 * @LastEditTime: 2022-07-22 18:07:38
-->
<template>
  <div class="blob-activle-box">
    <BlobActivleTextView :data="activleArray"></BlobActivleTextView>
  </div>
</template>

<script>
import BlobActivleTextView from "./Item/index.vue";

export default {
  name: "BlobActivleView",
  components: {
    BlobActivleTextView,
  },
  setup() {
    const activleArray = [
      {
        ...
        explicabo quis illo possimus aspernatur iusto, praesentium dolores,`,
...
.blob-activle-box {
  padding: 0 calc($view-padding / 2) 0 $view-padding;
}
</style>
